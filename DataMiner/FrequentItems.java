...
public class FrequentItems {
    ...
    */
     ...
     * @throws IOException
     */
    public FrequentItems findFrequentPairs() throws Exception {
    	...
    	for(int k=0;k<inputPath.length();k++) {
    		...
    		String[] bucketSplit = bucketlist.toArray(new String[bucketlist.size()]);
     ...
     * @return
     */
    public int findFrequentAll() throws Exception {
